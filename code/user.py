...
def aplicar_transferencias_cosechas(df_cosechas, df_tanques):
    ...
    for index, row in df_cosechas.iterrows():
        ...
        cosechas_por_tanque[tanque].append(index)  # Guardamos el índice de cada cosecha en orden
...
def ajustar_oro_generalizado(df_tanques, betas):
